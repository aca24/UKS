package com.github.minigithub.config;
...
import com.github.minigithub.security.auth.RestAuthenticationEntryPoint;
import com.github.minigithub.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                //.antMatchers(HttpMethod.GET, "/api/label").hasRole("ROLE_ADMIN")
